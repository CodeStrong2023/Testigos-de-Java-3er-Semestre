...
--INSERT INTO persona(nombre, apellido, email)VALUES ('Susana', 'Lara', 'slara@email.com')
--Hacemos la consulta para ver toda la informacion de la tabla
--SELECT * FROM persona
--UPDATE persona SET nombre = 'Ivonne', email = 'iesparza@email.com' WHERE id_persona=3
SELECT * FROM persona
